<div class="bg-white py-14 px-6 sm:px-12 bg-gradient-to-r from-pink-50 via-pink-50 to-blue-100 font-[sarabun]">
    <div class="max-w-screen-xl mx-auto">
        ...
        <div class="grid lg:grid-cols-2 gap-16 lg:gap-12 mt-6">
            <div>
                <p class="text-slate-600 md:text-md leading-relaxed mx-auto max-w-screen-xl">ขอขอบคุณผู้ปกครองนักเรียน นักศึกษาที่ให้ความไว้วางใจวิทยาลัย ที่ให้ความร่วมมืออย่างดีในกิจกรรมต่างๆ ของวิทยาลัยฯ
                ...
                <div class="max-w-screen-md mt-2">
                    <h2 class="xl:text-xl md:text-xl text-xl font-sm !leading-tight text-[#801810]">“เทคนิคตราดโฉมใหม่ ใส่ใจบุตรหลาน จัดการศึกษา เพื่อการมีงานทำ”</h2>
                </div>
                <div class="mt-12 flex gap-6 items-center flex-wrap">
                    <button type='button'
                        class="bg-[#55F5A3] hover:bg-green-400 transition-all text-slate-900 font-semibold text-[15px] rounded-full px-6 py-3 cursor-pointer">Getting
                        Started</button>
                    <a href="javascript:void(0)"
                        class="text-slate-900 text-[15px] font-semibold underline max-sm:block whitespace-nowrap">API
                        Documentation</a>
                </div>
                <div class="mt-12 flex flex-wrap gap-x-2 gap-y-2">
                    ...
                    <a href="https://admission.vec.go.th/web/Login.htm?mode=index" target="_blank">
                        <img src="images/std_register.png" class="w-48 h-32 shrink-0 shadow-2xl rounded-md p-2 hover:scale-[1.05] transition-all" alt="brand-logo3" />
                    </a>
                </div>
            </div>
